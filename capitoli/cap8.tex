...
\begin{minipage}{0.56\textwidth} % Colonna Sinistra (48% della larghezza del testo)
    \centering
        \includegraphics[width=0.95\textwidth]{cap8/rgb}     
\end{minipage}
\hfill % Spazio elastico per separare le due colonne
...
\begin{figure}[htbp]
        \centering
        \includegraphics[width=0.5\textwidth]{cap8/analisi_colore_risultato} 
...
\begin{figure}[htbp]
        \centering
        \includegraphics[width=0.9\textwidth]{cap8/camera} 
