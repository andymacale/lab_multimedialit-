...
\begin{figure}[htbp]
        \centering
        \includegraphics[width=0.9\textwidth]{cap6/roi} 
...
\begin{figure}[htbp]
        \centering
        \includegraphics[width=1\textwidth]{cap6/schema2} 
...
\begin{figure}[htbp]
        \centering
        \includegraphics[width=0.3\textwidth]{cap6/code} 
...
\begin{minipage}{0.68\textwidth} % Colonna Destra (48% della larghezza del testo)
    \centering
        \includegraphics[width=0.9\textwidth]{cap6/quantizzazione}
...
\begin{figure}[htbp]
        \centering
        \includegraphics[width=0.6\textwidth]{cap6/ebcot} 
...
\begin{figure}[htbp]
        \centering
        \includegraphics[width=0.8\textwidth]{cap6/qualita} 
