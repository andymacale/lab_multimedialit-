...
l'andamento delle frequenze nel tempo, si usa il cosiddetto spettogramma, che mostra le variazioni di intensità di diverse componenti delle frequenze. 
\begin{figure}[H]
        \centering
        \includegraphics[width=0.7\textwidth]{cap12/spettrogramma} 
        \caption{Esempio di spettogramma} 
