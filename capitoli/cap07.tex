...
solo due dimensioni. Innanzittutto, è necessario comprendere il funzionamento del nervo oculomotore.
...
In questo paragrafo, vengono trattati i cosiddetti indicatori monoculari di profondità statici, cioè quelle caratteristiche che forniscono delle
...
Le dimensioni relative forniscono informazioni 3D, grazie ad oggetti della stessa dimensione fisica che proiettano immagini retiniche di dimensione diversa
...
La tessitura consiste in una superficie molto estesa con una tessitura non uniforme proietterà sulla retina un'immagine, in cui la frequenza della tessitura
...
fornisce informazioni sulle distanze nello spazio tridimensionale. Un classico esempio sono i binari del treno: l'informazione aggiunta viene fornita grazie
...
La prospettiva aerea descrive il fatto che la luce degli oggetti più lontani, prima di raggiungere la nostra retina, deve attraversare più parti dell'atmosfera
rispetto a quella degli oggetti più vicini.
\begin{figure}[htbp]
        \centering
...
\end{figure}
\subsection{Ombre}
L'occlusione delle fonte di luce crea delle ombre, permettendo di avere informazioni sulla struttura tridimensionale della scena.
\begin{figure}[htbp]
        \centering
...
elevato. In questo paragrafo, verranno trattati nel dettaglio.
...
La seconda tipologia, ed anche la più significativa, è la funsione sensoriale, che rappresenta la capacità intrinseca del cervello di elaborare e integrare le informazioni visive grezze provenienti dai due occhi, unendole in un'unica percezione visiva (immagine singola).\\
...
\end{figure}
 ...
 \begin{itemize}
        ...
        \item diplopia fisiologica, che è lo sdoppiamento fisiologico dei punti che giacciono fuori dall'oroptero, perciò $BR$ e $BL$ sono punti retinici disparati,
...
La stereopsi è la capacità del cervello di fondere due immagini provenienti dagli occhi per costruire una visione tridimensionale di un oggetto osservato.
...
viste provenienti da due occhi, che sono leggermente traslati, la cui distanza di traslazione prende il nome di disparità. A questo punto, la profondità
