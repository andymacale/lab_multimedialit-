...
\begin{figure}[htbp]
    ...
    \label{fig:grayl}
\end{figure}
La terza ed ultima funzione di trasformazione lineare a tratti è il bit-plaine slicing, che consiste nel mettere evidenza solamente i bit più significativi (che sono i primi bit).
