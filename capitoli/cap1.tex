...
\begin{figure}[htbp]
        \centering
        \includegraphics[width=0.6\textwidth]{cap1/occhio} 
        \caption{Struttura dell'occhio umano} 
        \label{fig:occhio}
\end{figure}
\subsection{Cornea e coroide: due membrane come protezione}
La cornea è la membrana più esterna dell'occhio umano: infatti, essendo composta da un tessuto resistente e trasparente, è perfetta per racchiude la superficie anteriore dell'occhio.
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth} % Minipage che occupa quasi metà della larghezza del testo
        ...
        {immagini/cap1/Cornsweet_illusion.png} % L'immagine occupa tutta la larghezza della minipage
        \label{fig:cornsweet}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\textwidth} % Minipage che occupa quasi metà della larghezza del testo
        \centering % Centra l'immagine all'interno della minipage
        \includegraphics[width=\textwidth]{immagini/cap1/Illusion_of_gray_dots_nevit_065.svg.png} % L'immagine occupa tutta la larghezza della minipage
        \label{fig:grigliall}
    \end{minipage}
...
\end{equation*}
Il livello di grigio trovato appartiene ad un intervallo dove il minimo corrisponde corrisponde al nero ed il massimo corrisponde al massimo.
\begin{equation*}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth} % Minipage che occupa quasi metà della larghezza del testo
        \centering % Centra l'immagine all'interno della minipage
        \includegraphics[width=\textwidth]{immagini/cap1/ritratto.jpg}
    ...
    \begin{minipage}{0.48\textwidth} % Minipage che occupa quasi metà della larghezza del testo
        \centering % Centra l'immagine all'interno della minipage
        \includegraphics[width=\textwidth]{immagini/cap1/vasi.png} % L'immagine occupa tutta la larghezza della minipage
        \label{fig:griglia}
    \end{minipage}
...
\begin{itemize}
    ...
    \item $s$ è il livello di griglio di output.
\end{itemize}
...
\begin{figure}[H]
        \centering
        \includegraphics[width=1\textwidth]{immagini/cap1/manipolazione.png} 
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{immagini/cap1/negativo.png} 
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{immagini/cap1/log.png} 
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.6\textwidth]{immagini/cap1/gamma.png} 
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{immagini/cap1/calibrazione.png} 
...
\begin{center}
    ...
    \begin{equation*}
        ...
        & s = 
            ...
            \end{dcases}
        &
        \raisebox{-0.5\height}{\includegraphics[width=0.45\textwidth]{cap1/contrast.png}} 
        \end{aligned}
    \end{equation*}
...
\begin{center}
    \begin{equation*}
        ...
        \raisebox{-0.5\height}{\includegraphics[width=0.45\textwidth]{cap1/thresholding.png}} 
        \end{aligned}
    \end{equation*}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{immagini/cap1/gray-level-slicing.png} 
...
Quando si parla di un'immagine, è possibile costruire l'istogramma dell'immagine stessa, che non è altro che il numero di pixel che contengono un determinato valore di livello di griglio per ogni livello $n_k$.
\begin{center}
    % Uso \begin{equation*} e \end{equation*} per contenere l'ambiente align*
    \begin{equation*}
        \begin{aligned}[t] 
        & 
            ...
            \end{bmatrix}
        &
        \raisebox{-0.5\height}{\includegraphics[width=0.45\textwidth]{cap1/istogramma.png}} 
        \end{aligned}
    \end{equation*}
...
\begin{center}
    ...
    \begin{equation*}
        ...
        & 
            ...
            \end{bmatrix}
        &
        \raisebox{-0.5\height}{\includegraphics[width=0.45\textwidth]{cap1/istogramma2.png}} 
        \end{aligned}
    \end{equation*}
