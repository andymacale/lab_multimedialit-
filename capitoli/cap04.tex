...
\end{center}
\begin{itemize}
    \item $k=0$: $8c_{2, 0}=2 \leftrightarrow c_{2, 0} = 4$;
    \item $k=1$: $2c_{2, 1}=2 \leftrightarrow c_{2, 1} = 1$;
    \item $k=2$: $4c_{2, 2}=2 \leftrightarrow c_{2, 2} = 2$;
    \item $k=3$: $6c_{2, 3}=2 \leftrightarrow c_{2, 1} = 3$.
\end{itemize}
\begin{equation*}
...
\begin{itemize}
    \item contiene i stessi pixel dell'immagine originale;
    \item le sue statistiche locali rimangono relativamente costanti e facilmente modellate;
    \item molti valori sono nulli od infinitesimi, perciò è un'ottima candidata alla compressione (trattata nel prossimo capitolo);
    \item si possono estrarre sia le approssimazione grossolane sia quelle fini.
\end{itemize}
