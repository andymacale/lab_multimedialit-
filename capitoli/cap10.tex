...
La compressione basata sul block matching ci basa sulla tecnica appena spiegata del block matching. Assumendo un frame $f_{-1}$ che è stato codificato
...
\begin{itemize}
    ...
    \item HEVC (H.265): progettato per risoluzioni in 4K, per ridurre il bit-rate anche del $50 \%$, usa una struttura a Quadtree con Coding Tree Unit (CTU) da blocchi $8\times8$ fino a $64\times64$, che si adattano meglio al contenuto dell'immagine.
\end{itemize}
\begin{figure}[htbp]
        \centering
