...
\subsection{Codifica di Huffmann}
La codifica di Huffmann è un sistema di codifica lossless, che usa gli alberi binari come struttura dati per costruire la codifica, la cui costruzione si
...
\begin{figure}[htbp]
        \centering
        \includegraphics[width=0.35\textwidth]{cap5/huffmann} 
        \caption{Esempio di una codifica di Huffmann} 
        \label{fig:huffmann}
\end{figure}
...
qualsiasi altra codifica lossless, ottenendo sempre una compressione lossless.
\begin{figure}[htbp]
        \centering
        \includegraphics[width=1\textwidth]{cap5/bit} 
