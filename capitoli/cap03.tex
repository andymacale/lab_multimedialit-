...
\begin{figure}[H]
        \centering
        \includegraphics[width=0.6\textwidth]{cap03/tf} 
...
\begin{figure}[htbp]
        \centering
        \includegraphics[width=0.9\textwidth]{cap03/frequenza} 
...
La potenzialità del passaggio dal dominio spaziale al dominio della frequenza sta nel teorema della convoluzione. Tale teorema afferma che eseguire una convoluzione nel dominio spaziale corrisponde ad eseguire un prodotto nel dominio della frequenza, con un costo computazionale molto meno elevato.
\begin{center}
...
\begin{figure}[htbp]
        \centering
        \includegraphics[width=0.9\textwidth]{cap03/schema} 
...
\begin{figure}[htbp]
        \centering
        \includegraphics[width=0.65\textwidth]{cap03/notch} 
...
\begin{figure}[htbp]
        \centering
        \includegraphics[width=0.9\textwidth]{cap03/butterworth} 
        \caption{Vari ordini del filtro passa-basso di Butterworth} 
        \label{fig:LPF_ideale3}
\end{figure}
...
\begin{figure}[htbp]
        \centering
        \includegraphics[width=0.9\textwidth]{cap03/gaussiana} 
        \caption{Filtri passa-basso Gaussiani} 
        \label{fig:LPF_ideale2}
\end{figure}
\section{Filtri passa-alto}
I filtri passa-alto (HPF, dall'inglese high-pass filter) attenuano le basse frequenze e risaltano le alte frequenze, applicando quindi l'effetto di esaltazione dei dettagli. Infatti, corrispondono ai filtri di nitidezza nel dominio spaziale. Anche in questo caso, si ha la distanze euclidea e la frequenza di cutoff.\\
Inoltre, la funzione di trasferimento di un filtro passa-alto è l'inverso di quello del filtro passa-basso.
\begin{equation*}
        H_{HPF}(u,v) = 1 - H_{LPF}(u,v)
\end{equation*}
\subsection{Filtro passa-alto ideale, di Butterworth e Gaussiano}
Di seguito, sono riportate le formule dei filtri passa-alto ideale, di Butterworth e Gaussiano, che presentano le proprietà inverse di quelle del passa-basso.
\begin{center}
...
\begin{figure}[htbp]
        \centering
        \includegraphics[width=0.85\textwidth]{cap03/HPF} 
...
\end{equation*}
In frequenza, la trasformata di Fourier della derivata è la seguente:
\begin{equation*}
...
\begin{figure}[htbp]
        \centering
        \includegraphics[width=0.9\textwidth]{cap03/Laplaciano} 
